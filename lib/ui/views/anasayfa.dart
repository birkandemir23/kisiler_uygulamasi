...
class _AnasayfaState extends State<Anasayfa> {
  ...
  Future<List<Kisiler>> kisileriYukle() async {
    ...
    var k1 = Kisiler(kisi_id: 1, kisi_ad: "Birkan", kisi_tel: "5050761884");
    var k2 = Kisiler(kisi_id: 2, kisi_ad: "Aykut", kisi_tel: "5368952738");
    var k3 = Kisiler(kisi_id: 3, kisi_ad: "Beyto", kisi_tel: "5394565514");
                          ...
                          Padding(
                            ...
                            child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                Text(kisi.kisi_tel, style: TextStyle(fontSize: 15),),
                              ],
                            ),
                          ),
                          const Spacer(),
